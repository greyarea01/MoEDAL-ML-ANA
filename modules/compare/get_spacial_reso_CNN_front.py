...
def plot(list, dist, pred_list, name="CNN_front", log=False, save=False):
    """
...
def get_spacial_reso_CNN_front():
    """
    Computes the spatial resolution for CNN front pits, comparing the predicted and true pits.
    ...
    plot(nearest_x_y_dist_of_all_pred, nearest_distance_of_all_pred, nearest_point_in_true_of_all_pred,
         name="CNN_front_all_pred", log=True, save=True)
    ...
    plot(nearest_x_y_dist_of_true_pred, nearest_distance_of_true_pred, nearest_point_in_true_eval_of_true_pred,
         name="CNN_front_true_pred", save=True)


# Call the main function to evaluate spatial resolution
if __name__ == "__main__":
    get_spacial_reso_CNN_front()
