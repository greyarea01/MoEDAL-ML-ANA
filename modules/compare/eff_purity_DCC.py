"""
Get all predicted list from DCC front
...
def evaluate_efficiency_purity_DCC():
	"""
	Main function to evaluate efficiency and purity for DCC front pits using the true and predicted lists.
	...
	plt.show()
	fig.savefig('plots/eff_purr_DCC', dpi=200, bbox_inches='tight')

# Call the main function to evaluate efficiency and purity
if __name__ == "__main__":
	evaluate_efficiency_purity_DCC()
